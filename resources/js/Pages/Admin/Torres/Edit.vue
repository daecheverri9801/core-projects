  ...
  <SidebarBannerLayout>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow p-8">
      <div class="flex items-center justify-between mb-4">
        ...
        <Link :href="route('admin.torres.show', torre.id_torre)" class="px-4 py-2 rounded border hover:bg-gray-50">Volver</Link>
      </div>
...
const form = useForm({
  ...
  numero_pisos: props.torre?.numero_pisos ?? '',
  id_proyecto: props.torre?.id_proyecto || '',
  id_estado: props.torre?.id_estado || '',
})

function submit() {
  form.put(route('admin.torres.update', props.torre.id_torre))
}
</script>