          ...
          <div class="grid grid-cols-3 gap-6">
            <div>
              ...
              <input
                ...
                class="block w-full rounded-md border border-gray-300 px-4 py-2 focus:border-brand-500 focus:ring-1 focus:ring-brand-500"
              />
              <p v-if="form.errors.porcentaje_cuota_inicial_min" class="mt-1 text-sm text-red-600">
                {{ form.errors.porcentaje_cuota_inicial_min }}
              </p>
            </div>

            <div>
              <label for="valor_min_separacion" class="block text-sm font-medium text-gray-700 mb-1"
