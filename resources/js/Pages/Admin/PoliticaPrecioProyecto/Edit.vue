<template>
  <SidebarBannerLayout :empleado="empleado">
    <template #title>Editar Política de Precio</template>

    <div class="bg-white rounded-lg border p-4 md:p-6 max-w-3xl">
      <h2 class="text-lg font-semibold text-brand-900 mb-4">Editar Política</h2>
...
const submit = () => form.put(`/politicas-precio-proyecto/${props.politica.id_politica_precio}`)
</script>
